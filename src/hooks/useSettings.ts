...
function useSettingsInternal() {
  ...
  return {
    ...
    ttsWaitTime: store.ttsWaitTime,
    ttsEndpointUrl: store.ttsEndpointUrl,
    ttsApiKey: store.ttsApiKey,
    ttsVoice: store.ttsVoice,
    ttsModel: store.ttsModel,
    setTtsEnabled: store.setTtsEnabled,
    setTtsWaitTime: store.setTtsWaitTime,
    setTtsEndpointUrl: store.setTtsEndpointUrl,
    setTtsApiKey: store.setTtsApiKey,
    setTtsVoice: store.setTtsVoice,
    setTtsModel: store.setTtsModel,
